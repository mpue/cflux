...
import { PersonAdd, People, Assignment, Build, School } from '@mui/icons-material';
  ...
  const cards = [
    {
      ...
      route: '/admin/onboarding/applicants',
      color: '#2196f3',
    },
    {
    ...
    },
    {
      ...
      route: '/admin/onboarding/employees',
      color: '#ff9800',
    },
    {
      title: 'Equipment',
      ...
      route: '/admin/onboarding/equipment',
      color: '#9c27b0',
    },
    {
      title: 'Schulungen',
      ...
      route: '/admin/onboarding/training',
      color: '#f44336',
    },
  ];

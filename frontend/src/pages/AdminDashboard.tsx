...
import { User, Project, AbsenceRequest, TimeEntry, Report, Location, Customer, Supplier, ComplianceViolation, ComplianceStats } from '../types';
...
type TabType = 'users' | 'projects' | 'locations' | 'customers' | 'suppliers' | 'absences' | 'timeEntries' | 'reports' | 'backup' | 'vacationPlanner' | 'holidays' | 'compliance';

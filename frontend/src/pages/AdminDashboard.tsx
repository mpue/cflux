...
import { User, Project, AbsenceRequest, TimeEntry, Report, Location, ComplianceViolation, ComplianceStats } from '../types';
...
type TabType = 'users' | 'projects' | 'locations' | 'absences' | 'timeEntries' | 'reports' | 'backup' | 'vacationPlanner' | 'holidays' | 'compliance';

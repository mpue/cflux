...
import { User, Project, AbsenceRequest, TimeEntry, Report, Location, Customer, ComplianceViolation, ComplianceStats } from '../types';
...
type TabType = 'users' | 'projects' | 'locations' | 'customers' | 'absences' | 'timeEntries' | 'reports' | 'backup' | 'vacationPlanner' | 'holidays' | 'compliance';

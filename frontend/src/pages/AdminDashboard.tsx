...
import { User, Project, AbsenceRequest, TimeEntry, Report, Location, Customer, Supplier, ArticleGroup, Article, ComplianceViolation, ComplianceStats } from '../types';
...
type TabType = 'users' | 'projects' | 'locations' | 'customers' | 'suppliers' | 'articleGroups' | 'articles' | 'absences' | 'timeEntries' | 'reports' | 'backup' | 'vacationPlanner' | 'holidays' | 'compliance';
